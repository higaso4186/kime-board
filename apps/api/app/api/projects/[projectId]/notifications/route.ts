import { CreateNotificationRequest, CreateNotificationResponse, ListNotificationsResponse } from "@/shared";
import { parseJson, validate } from "@/lib/zod";
import { jsonCreated, jsonError, jsonOk, toApiError } from "@/lib/http";
import { createNotification, listNotifications } from "@/repo/notifications";
